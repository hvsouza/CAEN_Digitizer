...
* Extra: Wavedump decreased sampling
  ...
  If you want to decrease/increase the sampling rate of the saved data, for example from 500 MS/s to 250 MS/s, or to 125 MS/s and so on, you need to edit the WaveDump.c file and "enable" my modifications. 
...
- If everthing is working probably, try following the instructions to debug the USB at #wavedump_debugging_usb.
- If none of this works, please refer to the documentation to understand the installation and contact CAEN Support.

** Wavedump related:
*** TODO
** GUI related:
*** Do you really need to use this lame GUI?
