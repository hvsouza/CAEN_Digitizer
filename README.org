...
** Using wavedump
   ...
   * [T] also [t]
   ...
   #+HTML: <img src=".repo_img/continuous_ex.png" align="center" width="400" />   
...
** Creating the project
   ...
   #+HTML: <img src=".repo_img/qtcreator_proj.png" align="center" width="800" />   

   Now, on the bottom left, change the building from *Debug* to *Release*. Run the project (Green arrow or Ctrl+R). 

   #+HTML: <img src=".repo_img/qtcreator_release.png" align="center" width="800" />   
