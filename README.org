...
** Installation
   ...
   The script has also created the folder: src_sh[:exports code]{~/Desktop/WaveDumpData}. To use the GUI, you need to execute wavedump while inside that folder, so wavedump will save the data there.
